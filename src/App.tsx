      ...
      <div className="min-h-screen w-full bg-black text-white relative overflow-hidden font-bebas">
        ...
        <main className="relative z-10 pt-32 md:pt-40">
          ...
          >
            ...
            <motion.p
              variants={fadeInUp}
              className="text-white text-xl md:text-2xl max-w-3xl mx-auto mb-12"
            >
         ...
         {/*  <section className="px-6 py-16 md:py-24 bg-black">
          ...
          <section className="px-6 py-24 md:py-40 bg-black">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              {/* Columna izquierda: las 3 cards en vertical */}
              <div className="flex flex-col gap-6">
                {[
                  ...
                  <motion.div
                    ...
                    className="group relative bg-black border-2 border-amber-400/30 rounded-2xl p-6 md:p-8 flex flex-col items-center justify-center text-center shadow-[0_4px_24px_0_rgba(245,158,11,0.10)] transition-all duration-[1100ms] ease-in-out
                      text-white cursor-pointer
                      hover:border-amber-400/30 hover:shadow-[0_0px_80px_0_rgba(245,158,11,0.32)]
                  ...
                  >
                    <div className="flex flex-col items-center justify-center w-full mb-6">
                      <span className="text-4xl md:text-5xl text-white transition-all duration-300">
                        {React.createElement(benefit.icon, { className: "text-4xl md:text-5xl text-white" })}
                      </span>
                    </div>
          ...
          <section className="px-6 py-24 md:py-40 bg-black">
            ...
            >
              ...
              >
                <FaGift className="text-4xl md:text-5xl mr-4 text-[#E5DAB4] group-hover:text-white transition-all duration-300" /> Registrarme Ahora
              </LoadingButton>
            </motion.div>
          </section>
        </main>
